...
<?php include('includes/slider.php');?>
    ...
    <div class="container">
        ...
        <h1 class="my-4">BLOODCONNECT NGO</h1>
            ...
            <div class="col-lg-4 mb-4">
                <div class="card">
                    <h4 class="card-header">Why donate us</h4>
                        ...
                        <p class="card-text" style="padding-left:2%">As everyone knows we are working for "BLOODCONNECT NGO" which is known for their work and charity in society.</p>
                </div>
            </div>
            <div class="col-lg-4 mb-4">
                <div class="card">
